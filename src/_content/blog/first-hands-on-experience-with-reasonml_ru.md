...
![Recursion](/uploads/recursion.jpg 'Recursion')
...
![Scooby doo mask reveal](/uploads/reveal.jpg 'Reveal')
...
![Webstorm plugin displays inferred types](/uploads/webstorm-reason-inference.jpg 'Webstorm plugin for reasonml')
...
![Neo stands in front of matrix of TVs](/uploads/matrix.jpg 'Matrix')
...
![Матрица в консоли хрома](/uploads/random-universe.jpg 'Матрица')
